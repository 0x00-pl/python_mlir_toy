module {
  ...
  toy.func @main() {
    ...
    %2 = toy.constant dense<[1.0, 2.0, 3.0, 4.0]> : tensor<4xf64> loc("tests/transpose.toy":7:19)
    %3 = toy.reshape(%2 : tensor<4xf64>) to tensor<2x2xf64> loc("tests/transpose.toy":7:5)
    %4 = toy.generic_call @multiply_transpose(%0, %2) : (tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64> loc("tests/transpose.toy":8:13)
    toy.print %4 loc("tests/transpose.toy":9:5)
